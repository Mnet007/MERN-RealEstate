    ...
    <div>
      ...
      max-w-6xl mx-auto">
        ...
        <div className="text-gray-400 text-xs sm:text-sm">
          At Nabil Homes, we make it effortless to find, buy, or rent a place you'll love — fast, simple, and stress-free. 
          <br />
          From cozy apartments to luxurious estates, explore a wide range of properties tailored to every lifestyle.
        </div>
